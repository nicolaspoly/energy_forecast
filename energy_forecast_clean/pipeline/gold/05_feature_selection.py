...
Source: workspace.energy_forecast.ml_features_gold
...
INPUT_TABLE = f"{CATALOG}.{SCHEMA}.ml_features_gold"
...
output_path = '/Workspace/Users/n.jouglet23@gmail.com/energy_forecast_clean/config/selected_features.yaml'
