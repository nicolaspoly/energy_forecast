...
"""
# 06 - Entraînement et sélection de features LightGBM

Ce notebook :

1. charge les features Gold ;
2. effectue un nettoyage technique des features ;
3. réalise un split strictement temporel ;
4. entraîne un LightGBM de référence ;
5. classe les features par gain ;
6. compare plusieurs nombres de features ;
7. entraîne le modèle final ;
8. enregistre le modèle et les artefacts dans MLflow.
"""
...
"""
## 3. Définition des features candidates

Les colonnes techniques, les identifiants temporels bruts et toutes les
cibles possibles sont exclus. Les variables cycliques restent incluses.
"""
...
"""
## 5. Présélection technique

Cette étape supprime uniquement :

- les features entièrement manquantes ;
- les features ayant plus de 30 % de valeurs manquantes ;
- les features constantes ;
- les features quasi constantes ;
- les colonnes texte non prises en charge, sauf `zone`.
"""
...
"""
## 6. Préparation des types

LightGBM peut utiliser directement une colonne Pandas de type `category`.
Cela évite d'imposer un ordre numérique arbitraire aux zones.
"""
...
"""
## 9. Modèle baseline avec toutes les features nettoyées
"""
...
"""
## 10. Importance des features du modèle baseline
"""
...
"""
## 11. Comparaison de plusieurs nombres de features
"""
...
"""
## 12. Choix du nombre final de features

On sélectionne le plus petit ensemble dont le MAPE est situé à moins
de la tolérance configurée par rapport au meilleur MAPE.
"""
...
"""
## 13. Réentraînement final sur train + validation

Le meilleur nombre d'itérations a été déterminé avec la validation.
Le modèle final est ensuite réentraîné sur train + validation.
Le test reste totalement isolé jusqu'à l'évaluation finale.
"""
...
"""
## 14. Évaluation finale sur le test
"""
...
"""
## 17. Visualisation réel contre prédit
"""
...
"""
**Étape suivante :** adapter `09_batch_prediction.py` pour :

- charger `selected_features.json` ;
- créer exactement les mêmes colonnes ;
- appliquer les mêmes catégories à `zone` ;
- charger le modèle à partir de son URI MLflow ;
- écrire les prédictions dans une table Delta.
"""
